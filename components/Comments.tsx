...
const Comments = ({
  ...
  return (
    <>
      <div className="  border-t-2 border-gray-200 pt-4 px-10 mt-4 bg-[#F8F8F8] border-b-2 lg:pb-0 pb-[100px] md:pb-0">
        <div className=" overflow-scroll lg:h-[320px] ">
          {comments?.length ? (
      ...
      {userProfile && (
        <div className=" lg:absolute bottom-0 left-0 pb-4 lg:px-10 mt-10 mb-4 md:block ">
